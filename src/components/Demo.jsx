...
const Demo = () => {
    ...
    const handleDelete = (index) => {
        const newArticles = allArticles.filter((_, i) => i !== index);
                ...
                <div className='flex flex-col gap-1 max-h-100 overflow-y-auto'>
                    {allArticles.reverse().map((item, index) => (
                        ...
                        >
                            ...
                            <button onClick={() => handleDelete(index)} className='bg-red-400 hover:bg-red-700 text-white font-bold py-1 px-2 rounded'>
                                X
                            </button>
                        </div>
                    ))}
